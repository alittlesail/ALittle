					...
					word16_t *quantizedAdaptativeCodebookGain, word16_t *quantizedFixedCodebookGain, uint16_t *gainCodebookStage1, uint16_t *gainCodebookStage2)
{
	...
	xy = (word32_t)(SHR64(((xy64<0)?-xy64:xy64),30));
	yy = (word32_t)(SHR64(yy64,31));
	xz = (word32_t)(SHR64(((xz64<0)?-xz64:xz64),30));
	yz = (word32_t)(SHR64(((yz64<0)?-yz64:yz64),30));
	zz = (word32_t)(SHR64(zz64,31));
