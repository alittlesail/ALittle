...
function AVersionManager:CheckVersionUpdateImpl()
	...
	local result = self._version_system:UpdateVersion("139.159.176.119", 1011, nil, true)
...
function AVersionManager:UpdateVersion(check)
	...
	local result = self._version_system:UpdateVersion("139.159.176.119", 1011, Lua.Bind(self.HandleUpdateVersion, self), check)
	if result == 2 or result == 3 then
