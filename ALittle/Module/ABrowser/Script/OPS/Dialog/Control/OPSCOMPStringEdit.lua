...
ALittle.RegStruct(666255156, "ABrowser.OPSCOMPStringEditLinkInfo", {
name = "ABrowser.OPSCOMPStringEditLinkInfo", ns_name = "ABrowser", rl_name = "OPSCOMPStringEditLinkInfo", hash_code = 666255156,
name_list = {"_text_edit","_background"},
type_list = {"ALittle.TextEdit","ALittle.DisplayObject"},
option_map = {}
})
...
OPSCOMPStringEdit = Lua.Class(ABrowser.OPSCOMPBase, "ABrowser.OPSCOMPStringEdit")
...
function OPSCOMPStringEdit:Ctor(ctrl_sys, center, field_config, data)
	...
	self._input_link._text_edit:AddEventListener(___all_struct[-644464135], self, self.HandleTextEditFocusin)
	self._input_link._text_edit:AddEventListener(___all_struct[292776509], self, self.HandleTextEditFocusout)
	self:UpdateConfig()
end
