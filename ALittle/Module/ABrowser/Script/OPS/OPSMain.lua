...
ALittle.RegStruct(478555367, "ABrowser.OPSTreeUserData", {
name = "ABrowser.OPSTreeUserData", ns_name = "ABrowser", rl_name = "OPSTreeUserData", hash_code = 478555367,
name_list = {"parent","table_data_config","tab"},
type_list = {"ABrowser.OPSTree","ABrowser.OPSSubMenuConfig","ABrowser.OPSTableData"},
option_map = {}
})

OPSMain = Lua.Class(nil, "ABrowser.OPSMain")
...
function OPSMain:HandleItemClick(event)
	...
	if user_data.tab == nil then
		user_data.tab = OPSTableData(g_Control, self._center, user_data.table_data_config)
	end
