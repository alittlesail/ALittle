...
ALittle.RegStruct(2111104908, "ABrowser.OPSTableDataRichGroupLineInfo", {
name = "ABrowser.OPSTableDataRichGroupLineInfo", ns_name = "ABrowser", rl_name = "OPSTableDataRichGroupLineInfo", hash_code = 2111104908,
name_list = {"height","width","childs","child_count"},
type_list = {"double","double","List<ALittle.DisplayObject>","int"},
option_map = {}
})
...
OPSTableDataRichGroup = Lua.Class(ALittle.DisplayLayout, "ABrowser.OPSTableDataRichGroup")
...
function OPSTableDataRichGroup:AddBr()
	local child = {}
	child["__class"] = "Br"
	local child_count = ALittle.List_MaxN(self._show_childs)
