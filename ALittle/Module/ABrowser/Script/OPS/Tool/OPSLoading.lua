...
ALittle.RegStruct(53898227, "ABrowser.OPSLoadingUserData", {
name = "ABrowser.OPSLoadingUserData", ns_name = "ABrowser", rl_name = "OPSLoadingUserData", hash_code = 53898227,
name_list = {"width","height","flag"},
type_list = {"double","double","bool"},
option_map = {}
})

assert(ALittle.DisplayLayout, " extends class:ALittle.DisplayLayout is nil")
OPSLoading = Lua.Class(ALittle.DisplayLayout, "ABrowser.OPSLoading")

function OPSLoading:Play()
	if self._loop_1 == nil then
		self._loop_1 = ALittle.LoopFunction(Lua.Bind(self.Update, self, self._c1, self._c1.x + self._c1.width / 2, self._c1.y + self._c1.height / 2), -1, 20, 1)
	...
	if self._loop_2 == nil then
		self._loop_2 = ALittle.LoopFunction(Lua.Bind(self.Update, self, self._c2, self._c2.x + self._c2.width / 2, self._c2.y + self._c2.height / 2), -1, 20, 1)
	...
	if self._loop_3 == nil then
		self._loop_3 = ALittle.LoopFunction(Lua.Bind(self.Update, self, self._c3, self._c3.x + self._c3.width / 2, self._c3.y + self._c3.height / 2), -1, 20, 1)
