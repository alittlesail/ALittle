...
AEditor.IDEIMEManager = JavaScript.Class(undefined, {
	Ctor : function() {
	},
	Setup : function() {
		...
		if (this._ime_dialog === undefined) {
			this._ime_dialog = AEditor.g_Control.CreateControl("ide_ime_dialog", this);
...
}, "AEditor.IDEIMEManager");

AEditor.g_IDEIMEManager = ALittle.NewObject(AEditor.IDEIMEManager);
}