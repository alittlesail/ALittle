...
ALittleIDE.IDEImageCutPlugin = JavaScript.Class(ALittle.DisplayLayout, {
	...
	EditTexture : function(file_path, is_circle, cut_size) {
		...
		this._src_image = ALittle.NewObject(ALittle.Image, ALittleIDE.g_Control);
