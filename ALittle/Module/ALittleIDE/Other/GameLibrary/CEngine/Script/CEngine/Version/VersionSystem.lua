...
local ___COROUTINE = coroutine.running()
	...
	do
		...
		self._doing = true
		local error, result = Lua.IHttpSender.Invoke("VersionServer.QUpdateVersion", self._ask_update_request, param)
	...
	do
		...
		local error = Lua.IHttpFileSender.InvokeDownload("VersionServer.QDownloadVersionFile", self._current_request, param)
