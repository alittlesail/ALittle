...
ModuleRouteManager = Lua.Class(nil, "GatewayServer.ModuleRouteManager")

function ModuleRouteManager:Ctor()
...
function ModuleRouteManager:HandleAnySessionConnected(event)
...
function ModuleRouteManager:HandleAnySessionDisconnected(event)
...
function ModuleRouteManager:HandleUpdateRouteInfo(client, msg)
...
function ModuleRouteManager:HandleUpdateRouteWeight(client, msg)
...
function ModuleRouteManager:GetRouteInfo(route_type)
	local min_weight = 0
	local target = nil
...
g_ModuleRouteManager = ModuleRouteManager()
function HandleSession_NUpdateRouteInfo(client, msg)
	g_ModuleRouteManager:HandleUpdateRouteInfo(client, msg)
	g_DataRouteManager:HandleUpdateRouteInfo(client, msg)
end

ALittle.RegMsgCallback(-370290946, HandleSession_NUpdateRouteInfo)
function HandleNUpdateRouteWeight(client, msg)
	g_ModuleRouteManager:HandleUpdateRouteWeight(client, msg)
	g_DataRouteManager:HandleUpdateRouteWeight(client, msg)
end
...
ALittle.RegHttpCallback("GatewayServer.QRouteInfo", HandleQRouteInfo)
