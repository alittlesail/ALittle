...
require(___thispath.."IDEUtility")
require(___thispath.."IDEDataCore/IDEEnum")
require(___thispath.."IDEDataCore/IDEExport")
require(___thispath.."IDEEditCore/IDETabChild")
require(___thispath.."IDEEditCore/IDETabManager")
require(___thispath.."IDEEditCore/IDETreeLogic")
require(___thispath.."IDEEditCore/IDETree")
require(___thispath.."IDEEditCore/IDETreeItem")
require(___thispath.."IDEEditCore/IDERevocation")
require(___thispath.."IDEEditCore/IDEAttrTextDialog")
require(___thispath.."IDEEditCore/IDEAttrEventDialog")
require(___thispath.."IDEEditCore/IDEAttrImageDialog")
require(___thispath.."IDEEditCore/IDEEditImageDialog")
require(___thispath.."IDEEditCore/IDEImageCutPlugin")
require(___thispath.."IDEEditCore/IDESetting/DisplayObjectS")
require(___thispath.."IDEEditCore/IDESetting/DisplayLayoutS")
require(___thispath.."IDEEditCore/IDESetting/DisplayViewS")
require(___thispath.."IDEEditCore/IDESetting/TextCheckButtonS")
require(___thispath.."IDEEditCore/IDESetting/DialogS")
require(___thispath.."IDEEditCore/IDESetting/DropDownS")
require(___thispath.."IDEEditCore/IDESetting/Grid3S")
require(___thispath.."IDEEditCore/IDESetting/Grid9S")
require(___thispath.."IDEEditCore/IDESetting/Grid9ImageS")
require(___thispath.."IDEEditCore/IDESetting/TextS")
require(___thispath.."IDEEditCore/IDESetting/TextEditS")
require(___thispath.."IDEEditCore/IDESetting/ImageEditS")
require(___thispath.."IDEEditCore/IDESetting/TextInputS")
require(___thispath.."IDEEditCore/IDESetting/ImageInputS")
require(___thispath.."IDEEditCore/IDESetting/ImageS")
require(___thispath.."IDEEditCore/IDESetting/TriangleS")
require(___thispath.."IDEEditCore/IDESetting/ImagePlayS")
require(___thispath.."IDEEditCore/IDESetting/FramePlayS")
require(___thispath.."IDEEditCore/IDESetting/SpriteS")
require(___thispath.."IDEEditCore/IDESetting/SpritePlayS")
require(___thispath.."IDEEditCore/IDESetting/LinearS")
require(___thispath.."IDEEditCore/IDESetting/QuadS")
require(___thispath.."IDEEditCore/IDESetting/RichAreaS")
require(___thispath.."IDEEditCore/IDESetting/RichInputS")
require(___thispath.."IDEEditCore/IDESetting/RichEditS")
require(___thispath.."IDEEditCore/IDESetting/SliderS")
require(___thispath.."IDEEditCore/IDESetting/ScrollBarS")
require(___thispath.."IDEEditCore/IDESetting/ScrollButtonS")
require(___thispath.."IDEEditCore/IDESetting/ScrollListS")
require(___thispath.."IDEEditCore/IDESetting/ScrollScreenS")
require(___thispath.."IDEEditCore/IDESetting/TabS")
require(___thispath.."IDEEditCore/IDESetting/TextAreaS")
require(___thispath.."IDEEditCore/IDESetting/TextButtonS")
require(___thispath.."IDEEditCore/IDESetting/SpringTextButtonS")
require(___thispath.."IDEEditCore/IDESetting/TextRadioButtonS")
require(___thispath.."IDEEditCore/IDESetting/TileTableS")
require(___thispath.."IDEEditCore/IDESetting/PiechartS")
require(___thispath.."IDEEditLogic/IDETool")
require(___thispath.."IDEEditLogic/IDEMainMenu")
require(___thispath.."IDEEditLogic/IDEAttributeManager")
require(___thispath.."IDEEditLogic/IDEControlManager")
require(___thispath.."IDEEditLogic/IDEQuickManager")
require(___thispath.."IDEEditLogic/IDEAntiManager")
require(___thispath.."IDEEditLogic/IDEControlTree")
require(___thispath.."IDEEditLogic/IDEImageManager")
require(___thispath.."IDEEditLogic/IDEProjectManager")
require(___thispath.."IDEEditLogic/IDEVersionList")
require(___thispath.."IDEEditLogic/IDEVersionManager")
require(___thispath.."IDEEditLogic/IDELoginManager")
require(___thispath.."IDEEditLogic/IDEIMEManager")
