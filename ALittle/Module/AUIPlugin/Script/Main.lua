...
function __Plugin_Setup(control, module_base_path, script_base_path)
	...
	RequireFromPaths(script_base_path, "AUICodeEdit/", {"AUICodeSelectCursor.alittle", "AUICodeRevocation.alittle", "AUICodeProject.alittle", "AUICodeLanguage.alittle", "AUICodeEdit.alittle", "AUICodeCursor.alittle", "AUICodeCompleteScreen.alittle", "ABnf/AUICodeALittleScript.alittle", "ABnf/AUICodeABnf.alittle"})
