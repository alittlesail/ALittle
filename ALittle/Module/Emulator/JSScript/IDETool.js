...
Emulator.IDETool = JavaScript.Class(undefined, {
	ShowNotice : function(title, content) {
		if (this._notice_dialog === undefined) {
			this._notice_dialog = Emulator.g_Control.CreateControl("ide_notice_dialog", this);
...
Emulator.g_IDETool = ALittle.NewObject(Emulator.IDETool);
}