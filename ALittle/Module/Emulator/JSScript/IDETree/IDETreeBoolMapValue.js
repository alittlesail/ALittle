...
Emulator.IDETreeBoolMapValue = JavaScript.Class(Emulator.IDETreeLogic, {
	Ctor : function(ctrl_sys, root, parent, rflct, msg, key_field, value_field) {
		...
		this._item = ctrl_sys.CreateControl("ide_common_tree_bool_map_value", this);
