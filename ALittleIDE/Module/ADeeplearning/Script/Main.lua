...
function ADeeplearning.__Module_Setup(layer_group, control, module_base_path, script_base_path, debug)
	...
	RequireFromPaths(script_base_path, "Model/", {"Mnist/MnistTrainLayout.alittle", "Mnist/MnistTestLayout.alittle", "Mnist/MnistLayout.alittle"})
...
function ADeeplearning.__Plugin_Setup(control, module_base_path, script_base_path)
	...
	RequireFromPaths(script_base_path, "Mnist/", {"Mnist/MnistTrainLayout.alittle", "Mnist/MnistTestLayout.alittle", "Mnist/MnistLayout.alittle"})
end
