...
ALittleIDE.RichInputS = JavaScript.Class(ALittleIDE.DisplayLayoutS, {
	...
	LoadNatureBase : function() {
		...
		this.LoadBoolData("password_mode", true, ALittleIDE.g_IDEEnum.yn_type);
		this.LoadBoolData("input_align", true, ALittleIDE.g_IDEEnum.yn_type);
	...
	HandleInputAlignSELECT_CHANGE : function(event) {
		this.BoolSelectChange("input_align", false, ALittleIDE.g_IDEEnum.yn_type);
	},
