...
ALittle.UIEventDispatcher = Lua.Class(nil, "ALittle.UIEventDispatcher")

function ALittle.UIEventDispatcher:Ctor()
	___rawset(self, "_trans_target", ALittle.CreateValueWeakMap())
	___rawset(self, "_listeners", {})
	___rawset(self, "_abs_disabled", false)
end

function ALittle.UIEventDispatcher.__getter:event_trans_target()
	return self._trans_target["event"]
end

function ALittle.UIEventDispatcher.__setter:event_trans_target(value)
...
function ALittle.UIEventDispatcher.__getter:drag_trans_target()
	return self._trans_target["drag"]
end

function ALittle.UIEventDispatcher.__setter:drag_trans_target(value)
...
function ALittle.UIEventDispatcher.__getter:abs_disabled()
	return self._abs_disabled
end

function ALittle.UIEventDispatcher.__setter:abs_disabled(value)
	self._abs_disabled = value
end

function ALittle.UIEventDispatcher:AddEventListener(T, object, callback)
	local rflt = T
	return self:AddEventListenerImpl(rflt.name, object, callback)
end

function ALittle.UIEventDispatcher:AddEventListenerImpl(event_type, object, callback)
	if object == nil then
		return false
	end
...
function ALittle.UIEventDispatcher:RemoveEventListener(T, object, callback)
	local rflt = T
...
function ALittle.UIEventDispatcher:ClearEventListener()
	self._listeners = {}
end

function ALittle.UIEventDispatcher:DispatchEvent(T, event)
	local rflt = T
