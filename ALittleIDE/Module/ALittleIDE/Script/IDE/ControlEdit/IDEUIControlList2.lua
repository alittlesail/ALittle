...
ALittleIDE.IDEUIControlList2 = Lua.Class(ALittle.DisplayLayout, "ALittleIDE.IDEUIControlList2")

function ALittleIDE.IDEUIControlList2:Ctor(ctrl_sys)
	___rawset(self, "_group", {})
end

function ALittleIDE.IDEUIControlList2:TCtor()
...
function ALittleIDE.IDEUIControlList2:HandleProjectClose(event)
	self._control_scroll_screen:RemoveAllChild()
end

function ALittleIDE.IDEUIControlList2:HandleProjectOpen(event)
...
function ALittleIDE.IDEUIControlList2:AddModule(name)
...
function ALittleIDE.IDEUIControlList2:ShowTreeItemFocus(target)
	target:ShowSelect()
...
function ALittleIDE.IDEUIControlList2:HandleControlSearchClick(event)
...
function ALittleIDE.IDEUIControlList2:SetCutTreeItem(item)
	self._cut_item = item
	self._copy_item = nil
end

function ALittleIDE.IDEUIControlList2:GetCutTreeItem()
	return self._cut_item
end

function ALittleIDE.IDEUIControlList2:SetCopyTreeItem(item)
	self._copy_item = item
	self._cut_item = nil
end

function ALittleIDE.IDEUIControlList2:GetCopyTreeItem()
	return self._copy_item
end

function ALittleIDE.IDEUIControlList2:ClearCutAndCopy()
	self._cut_item = nil
	self._copy_item = nil
end
