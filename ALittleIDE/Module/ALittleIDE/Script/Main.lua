...
function ALittleIDE.__Module_Setup(layer_group, control, module_base_path, script_base_path)
	...
	RequireFromPaths(script_base_path, "IDE/", {"IDEUtility.alittle", "IDEUIProjectList.alittle", "IDEUIProjectDropdown.alittle"
		...
		, "ControlEdit/Tree/IDEControlTree.alittle", "TileEdit/IDEUITileList.alittle", "TileEdit/IDEUITileBrush.alittle"
		, "TileEdit/IDETileTabChild.alittle", "TileEdit/Dialog/IDETileSettingDialog.alittle", "UIEdit/IDEUIUtility.alittle"
