...
function ALittleIDE.__Module_Setup(layer_group, control, module_base_path, script_base_path)
	...
	RequireFromPaths(script_base_path, "IDE/", {"IDEUtility.alittle", "IDEUIProjectList.alittle", "IDEUIProjectDropdown.alittle"
		, "IDEUIMainMenu.alittle", "IDEUIControlList.alittle", "IDEUICenter.alittle"
		, "IDEUIAccount.alittle", "IDEContentEdit.alittle", "IDECenter.alittle"
		, "CodeEdit/IDEUICodeList.alittle", "CodeEdit/IDECodeUtility.alittle", "CodeEdit/IDECodeTabChild.alittle"
		, "CodeEdit/Tree/IDECodeTreeLogic.alittle", "CodeEdit/Tree/IDECodeTreeItem.alittle", "CodeEdit/Tree/IDECodeTree.alittle"
		, "ControlEdit/IDEUIControlList2.alittle", "ControlEdit/IDEControlUtility.alittle", "ControlEdit/Tree/IDEControlTreeLogic.alittle"
		, "ControlEdit/Tree/IDEControlTreeItem.alittle", "ControlEdit/Tree/IDEControlTree.alittle", "UIEdit/IDEUIUtility.alittle"
		, "UIEdit/IDEUITabChild.alittle", "UIEdit/IDEUIRevocation.alittle", "UIEdit/IDEUIControlTree.alittle"
		, "UIEdit/IDEUIControlAnti.alittle", "UIEdit/Dialog/IDEAttrTextDialog.alittle", "UIEdit/Dialog/IDEAttrEventDialog.alittle"
		, "UIEdit/Dialog/IDEAttrControlDialog.alittle", "UIEdit/Setting/DisplayObjectS.alittle", "UIEdit/Setting/DisplayLayoutS.alittle"
		, "UIEdit/Setting/DialogS.alittle", "UIEdit/Setting/TriangleS.alittle", "UIEdit/Setting/TileTableS.alittle"
		...
		, "UIEdit/Setting/SpriteS.alittle", "UIEdit/Setting/SpritePlayS.alittle", "UIEdit/Setting/SpringTextButtonS.alittle"
		, "UIEdit/Setting/SliderS.alittle", "UIEdit/Setting/ScrollScreenS.alittle", "UIEdit/Setting/ScrollListS.alittle"
		, "UIEdit/Setting/ScrollButtonS.alittle", "UIEdit/Setting/RichInputS.alittle", "UIEdit/Setting/RichEditS.alittle"
		, "UIEdit/Setting/RichAreaS.alittle", "UIEdit/Setting/QuadS.alittle", "UIEdit/Setting/PiechartS.alittle"
		, "UIEdit/Setting/LinearS.alittle", "UIEdit/Setting/ImageS.alittle", "UIEdit/Setting/ImagePlayS.alittle"
		, "UIEdit/Setting/ImageEditS.alittle", "UIEdit/Setting/Grid9S.alittle", "UIEdit/Setting/Grid9ImageS.alittle"
		, "UIEdit/Setting/Grid3S.alittle", "UIEdit/Setting/FramePlayS.alittle", "UIEdit/Setting/DropDownS.alittle"
		, "UIEdit/Setting/DisplayViewS.alittle", "UIEdit/Setting/TextRadioButtonS.alittle", "UIEdit/Setting/TextInputS.alittle"
		, "UIEdit/Setting/ScrollBarS.alittle", "UIEdit/Setting/ImageInputS.alittle", "UIEdit/Tree/IDEUITreeLogic.alittle"
