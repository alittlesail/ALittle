...
function ALittleIDE.__Module_Setup(layer_group, control, module_base_path, script_base_path)
	...
	RequireFromPaths(script_base_path, "IDE/", {"IDEUtility.alittle", "IDEUIProjectList.alittle", "IDEUIProjectDropdown.alittle"
		...
		, "TileEdit/IDETileTabChild.alittle", "UIEdit/IDEUIUtility.alittle", "UIEdit/IDEUITabChild.alittle"
		...
		, "UIEdit/Setting/TriangleS.alittle", "UIEdit/Setting/TileTableS.alittle", "UIEdit/Setting/TextS.alittle"
		, "UIEdit/Setting/TextEditS.alittle", "UIEdit/Setting/TextCheckButtonS.alittle", "UIEdit/Setting/TextButtonS.alittle"
		, "UIEdit/Setting/TextAreaS.alittle", "UIEdit/Setting/TabS.alittle", "UIEdit/Setting/SpriteS.alittle"
		, "UIEdit/Setting/SpritePlayS.alittle", "UIEdit/Setting/SpringTextButtonS.alittle", "UIEdit/Setting/SliderS.alittle"
		, "UIEdit/Setting/ScrollScreenS.alittle", "UIEdit/Setting/ScrollListS.alittle", "UIEdit/Setting/ScrollButtonS.alittle"
		, "UIEdit/Setting/RichInputS.alittle", "UIEdit/Setting/RichEditS.alittle", "UIEdit/Setting/RichAreaS.alittle"
		, "UIEdit/Setting/QuadS.alittle", "UIEdit/Setting/PiechartS.alittle", "UIEdit/Setting/LinearS.alittle"
		, "UIEdit/Setting/ImageS.alittle", "UIEdit/Setting/ImagePlayS.alittle", "UIEdit/Setting/ImageEditS.alittle"
		, "UIEdit/Setting/Grid9S.alittle", "UIEdit/Setting/Grid9ImageS.alittle", "UIEdit/Setting/Grid3S.alittle"
		, "UIEdit/Setting/FramePlayS.alittle", "UIEdit/Setting/DropDownS.alittle", "UIEdit/Setting/DisplayViewS.alittle"
		, "UIEdit/Setting/TextRadioButtonS.alittle", "UIEdit/Setting/TextInputS.alittle", "UIEdit/Setting/ScrollBarS.alittle"
