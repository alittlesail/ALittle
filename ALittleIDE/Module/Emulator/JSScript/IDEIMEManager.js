...
Emulator.IDEIMEManager = JavaScript.Class(undefined, {
	Ctor : function() {
	},
	Setup : function() {
		...
		if (this._ime_dialog === undefined) {
			this._ime_dialog = Emulator.g_Control.CreateControl("ide_ime_dialog", this);
...
}, "Emulator.IDEIMEManager");

Emulator.g_IDEIMEManager = ALittle.NewObject(Emulator.IDEIMEManager);
}