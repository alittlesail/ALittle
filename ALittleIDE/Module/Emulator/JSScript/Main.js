...
Emulator.__Browser_Setup = async function(layer_group, control, module_base_path, script_base_path) {
...
Emulator.g_AUIPluinControl = undefined;
Emulator.g_VersionManager = undefined;
Emulator.__Module_Setup = async function(layer_group, control, module_base_path, script_base_path, debug) {
	...
	Emulator.g_AUIPluinControl = await A_ModuleSystem.LoadPlugin("AUIPlugin");
