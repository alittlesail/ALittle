...
ProtobufEmulator.IDETreeBoolMapBool = Lua.Class(ProtobufEmulator.IDETreeLogic, "ProtobufEmulator.IDETreeBoolMapBool")

function ProtobufEmulator.IDETreeBoolMapBool:Ctor(ctrl_sys, root, parent, rflct, msg, key_field, value_field)
...
function ProtobufEmulator.IDETreeBoolMapBool:HandleKeySelectChanegd(event)
...
function ProtobufEmulator.IDETreeBoolMapBool:HandleValueSelectChanegd(event)
...
function ProtobufEmulator.IDETreeBoolMapBool:HandleInsertClick(event)
	self._parent:CreateOneBefore(self)
end

function ProtobufEmulator.IDETreeBoolMapBool:HandleDeleteClick(event)
