...
function SuperMarioBros.EditScene:TCtor()
	...
	self._entity_map = {}
	local info = {}
	info.ui = "random_wall_1"
	info.type = SuperMarioBros.EntityType.ET_RANDOM_WALL_1
	info.width = self._entity_random_wall_1.width
	info.height = self._entity_random_wall_1.height
	info.center_x = self._entity_random_wall_1.center_x
	info.center_y = self._entity_random_wall_1.center_y
	self._entity_random_wall_1._user_data = info
	self._entity_random_wall_1:AddEventListener(___all_struct[1883782801], self, self.HandleEntitySelectClick)
	self._entity_info_map[SuperMarioBros.EntityType.ET_RANDOM_WALL_1] = info
	info = {}
	info.ui = "hide_wall_1"
	info.type = SuperMarioBros.EntityType.ET_HIDE_WALL_1
	info.width = self._entity_hide_wall_1.width
	info.height = self._entity_hide_wall_1.height
	info.center_x = self._entity_hide_wall_1.center_x
	info.center_y = self._entity_hide_wall_1.center_y
	self._entity_hide_wall_1._user_data = info
	self._entity_hide_wall_1:AddEventListener(___all_struct[1883782801], self, self.HandleEntitySelectClick)
	self._entity_info_map[SuperMarioBros.EntityType.ET_HIDE_WALL_1] = info
	info = {}
	info.ui = "wall_1"
	info.type = SuperMarioBros.EntityType.ET_WALL_1
	info.width = self._entity_wall_1.width
	info.height = self._entity_wall_1.height
	info.center_x = self._entity_wall_1.center_x
	info.center_y = self._entity_wall_1.center_y
	self._entity_wall_1._user_data = info
	self._entity_wall_1:AddEventListener(___all_struct[1883782801], self, self.HandleEntitySelectClick)
	self._entity_info_map[SuperMarioBros.EntityType.ET_WALL_1] = info
	info = {}
	info.ui = "enemy_1"
	info.type = SuperMarioBros.EntityType.ET_ENEMY_1
	info.width = self._entity_enemy_1.width
	info.height = self._entity_enemy_1.height
	info.center_x = self._entity_enemy_1.center_x
	info.center_y = self._entity_enemy_1.center_y
	self._entity_enemy_1._user_data = info
	self._entity_enemy_1:AddEventListener(___all_struct[1883782801], self, self.HandleEntitySelectClick)
	self._entity_info_map[SuperMarioBros.EntityType.ET_ENEMY_1] = info
	info = {}
	info.ui = "enemy_2"
	info.type = SuperMarioBros.EntityType.ET_ENEMY_2
	info.width = self._entity_enemy_2.width
	info.height = self._entity_enemy_2.height
	info.center_x = self._entity_enemy_2.center_x
	info.center_y = self._entity_enemy_2.center_y
	self._entity_enemy_2._user_data = info
	self._entity_enemy_2:AddEventListener(___all_struct[1883782801], self, self.HandleEntitySelectClick)
	self._entity_info_map[SuperMarioBros.EntityType.ET_ENEMY_2] = info
	info = {}
	info.ui = "flag_1"
	info.type = SuperMarioBros.EntityType.ET_FLAG_1
	info.width = self._entity_flag_1.width
	info.height = self._entity_flag_1.height
	info.center_x = self._entity_flag_1.center_x
	info.center_y = self._entity_flag_1.center_y
	self._entity_flag_1._user_data = info
	self._entity_flag_1:AddEventListener(___all_struct[1883782801], self, self.HandleEntitySelectClick)
	self._entity_info_map[SuperMarioBros.EntityType.ET_FLAG_1] = info
	info = {}
	info.ui = "flag_2"
	info.type = SuperMarioBros.EntityType.ET_FLAG_2
	info.width = self._entity_flag_2.width
	info.height = self._entity_flag_2.height
	info.center_x = self._entity_flag_2.center_x
	info.center_y = self._entity_flag_2.center_y
	self._entity_flag_2._user_data = info
	self._entity_flag_2:AddEventListener(___all_struct[1883782801], self, self.HandleEntitySelectClick)
	self._entity_info_map[SuperMarioBros.EntityType.ET_FLAG_2] = info
	info = {}
	info.ui = "flag_3"
	info.type = SuperMarioBros.EntityType.ET_FLAG_3
	info.width = self._entity_flag_3.width
	info.height = self._entity_flag_3.height
	info.center_x = self._entity_flag_3.center_x
	info.center_y = self._entity_flag_3.center_y
	self._entity_flag_3._user_data = info
	self._entity_flag_3:AddEventListener(___all_struct[1883782801], self, self.HandleEntitySelectClick)
	self._entity_info_map[SuperMarioBros.EntityType.ET_FLAG_3] = info
	info = {}
	info.ui = "flag_4"
	info.type = SuperMarioBros.EntityType.ET_FLAG_4
	info.width = self._entity_flag_4.width
	info.height = self._entity_flag_4.height
	info.center_x = self._entity_flag_4.center_x
	info.center_y = self._entity_flag_4.center_y
	self._entity_flag_4._user_data = info
	self._entity_flag_4:AddEventListener(___all_struct[1883782801], self, self.HandleEntitySelectClick)
	self._entity_info_map[SuperMarioBros.EntityType.ET_FLAG_4] = info
	info = {}
	info.ui = "flag_5"
	info.type = SuperMarioBros.EntityType.ET_FLAG_5
	info.width = self._entity_flag_5.width
	info.height = self._entity_flag_5.height
	info.center_x = self._entity_flag_5.center_x
	info.center_y = self._entity_flag_5.center_y
	self._entity_flag_5._user_data = info
	self._entity_flag_5:AddEventListener(___all_struct[1883782801], self, self.HandleEntitySelectClick)
	self._entity_info_map[SuperMarioBros.EntityType.ET_FLAG_5] = info
end
