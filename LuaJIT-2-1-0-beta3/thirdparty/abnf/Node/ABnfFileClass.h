...
private:
    // 规则名映射规则内容
    std::unordered_map<std::string, std::unordered_set<ABnfElementPtr>> m_rule;
...
public:
    ...
    inline const std::unordered_map<std::string, std::unordered_set<ABnfElementPtr>>& GetRuleSet() { return m_rule; }
