...
static int alanguagelib_project_findfile(lua_State* L)
{
    void** c = (void**)lua_touserdata(L, 1);
    luaL_argcheck(L, c != 0, 1, "abnf project object is null");
    ...
    alanguage_project_findfile(*c, query_id, text);
    return 0;
}

static int alanguagelib_project_finddefine(lua_State* L)
{
    void** c = (void**)lua_touserdata(L, 1);
    luaL_argcheck(L, c != 0, 1, "abnf project object is null");
    int query_id = (int)luaL_checkinteger(L, 2);
    const char* pre_input = luaL_checkstring(L, 3);
    luaL_argcheck(L, pre_input != 0, 3, "pre_input is null");
    const char* input = luaL_checkstring(L, 4);
    luaL_argcheck(L, input != 0, 4, "input is null");

    alanguage_project_finddefine(*c, query_id, pre_input, input);
    return 0;
}

static int alanguagelib_project_findgoto(lua_State* L)
{
    void** c = (void**)lua_touserdata(L, 1);
    luaL_argcheck(L, c != 0, 1, "abnf project object is null");
    int query_id = (int)luaL_checkinteger(L, 2);
    ...
    alanguage_project_findgoto(*c, query_id, text);
    return 0;
}
...
static int alanguagelib_abnffile_queryparamlist(lua_State* L)
{
    void** c = (void**)lua_touserdata(L, 1);
    luaL_argcheck(L, c != 0, 1, "abnf file object is null");
    int query_id = (int)luaL_checkinteger(L, 2);
    ...
    int it_line = (int)luaL_checkinteger(L, 4);
    int it_char = (int)luaL_checkinteger(L, 5);
    abnffile_queryparamlist(*c, query_id, version, it_line - 1, it_char);
    return 0;
}

static int alanguagelib_abnffile_queryparamindex(lua_State* L)
{
    void** c = (void**)lua_touserdata(L, 1);
    luaL_argcheck(L, c != 0, 1, "abnf file object is null");
    int version = (int)luaL_checkinteger(L, 2);
    ...
    int start_offset = 0;
    lua_pushinteger(L, abnffile_queryparamindex(*c, version, it_line - 1, it_char, &start_offset) + 1);
...
static struct luaL_Reg alanguagelib[] = {
  ...
  {"abnfproject_findfile", alanguagelib_project_findfile},
  {"abnfproject_finddefine", alanguagelib_project_finddefine},
  {"abnfproject_findgoto", alanguagelib_project_findgoto},
  ...
  {"abnffile_queryparamlist", alanguagelib_abnffile_queryparamlist},
  {"abnffile_queryparamindex", alanguagelib_abnffile_queryparamindex},
