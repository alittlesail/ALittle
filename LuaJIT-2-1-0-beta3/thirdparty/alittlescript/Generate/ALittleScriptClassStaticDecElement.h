#ifndef _ALITTLE_ALittleScriptClassStaticDecElement_H_
#define _ALITTLE_ALittleScriptClassStaticDecElement_H_
...
class ALittleScriptClassStaticDecElement : public ABnfNodeElement
{
public:
    ALittleScriptClassStaticDecElement(ABnfFactory* factory, ABnfFile* file, int line, int col, int offset, const std::string& type)
        : ABnfNodeElement(factory, file, line, col, offset, type) { }
    virtual ~ALittleScriptClassStaticDecElement() { }
...
#endif // _ALITTLE_ALittleScriptClassStaticDecElement_H_
