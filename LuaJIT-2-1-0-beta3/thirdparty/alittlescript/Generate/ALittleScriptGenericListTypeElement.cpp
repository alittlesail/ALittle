...
std::shared_ptr<ALittleScriptAllTypeElement> ALittleScriptGenericListTypeElement::GetAllType()
{
...
std::shared_ptr<ALittleScriptKeyElement> ALittleScriptGenericListTypeElement::GetKey()
{
...
const std::vector<std::shared_ptr<ALittleScriptStringElement>>& ALittleScriptGenericListTypeElement::GetStringList()
{
