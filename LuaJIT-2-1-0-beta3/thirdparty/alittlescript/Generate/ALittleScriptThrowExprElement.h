#ifndef _ALITTLE_ALittleScriptThrowExprElement_H_
#define _ALITTLE_ALittleScriptThrowExprElement_H_
...
class ALittleScriptThrowExprElement : public ABnfNodeElement
{
public:
    ALittleScriptThrowExprElement(ABnfFactory* factory, ABnfFile* file, int line, int col, int offset, const std::string& type)
        : ABnfNodeElement(factory, file, line, col, offset, type) { }
    virtual ~ALittleScriptThrowExprElement() { }
...
#endif // _ALITTLE_ALittleScriptThrowExprElement_H_
