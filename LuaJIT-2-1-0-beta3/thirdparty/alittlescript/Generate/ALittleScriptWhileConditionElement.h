#ifndef _ALITTLE_ALittleScriptWhileConditionElement_H_
#define _ALITTLE_ALittleScriptWhileConditionElement_H_
...
class ALittleScriptWhileConditionElement : public ABnfNodeElement
{
public:
    ALittleScriptWhileConditionElement(ABnfFactory* factory, ABnfFile* file, int line, int col, int offset, const std::string& type)
        : ABnfNodeElement(factory, file, line, col, offset, type) { }
    virtual ~ALittleScriptWhileConditionElement() { }
...
#endif // _ALITTLE_ALittleScriptWhileConditionElement_H_
