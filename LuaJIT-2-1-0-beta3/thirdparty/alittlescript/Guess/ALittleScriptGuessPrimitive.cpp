...
ABnfGuessPtr ALittleScriptGuessPrimitive::ReplaceTemplate(const std::unordered_map<std::string, ABnfGuessPtr>& fill_map)
{
...
{
    return ABnfGuessPtr(new ALittleScriptGuessPrimitive(value, is_const));
}
