...
ALittleScriptCustomTypeDotIdReference::ALittleScriptCustomTypeDotIdReference(ABnfElementPtr element) : ALittleScriptCustomTypeCommonReference(std::dynamic_pointer_cast<ALittleScriptCustomTypeElement>(element->GetParent()), element)
{
