...
const std::vector<std::shared_ptr<ALittleScriptValueStatElement>>& ALittleScriptAssertExprElement::GetValueStatList()
{
...
std::shared_ptr<ALittleScriptKeyElement> ALittleScriptAssertExprElement::GetKey()
{
...
const std::vector<std::shared_ptr<ALittleScriptStringElement>>& ALittleScriptAssertExprElement::GetStringList()
{
