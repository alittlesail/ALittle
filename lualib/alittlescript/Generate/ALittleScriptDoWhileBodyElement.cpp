...
const std::vector<std::shared_ptr<ALittleScriptAllExprElement>>& ALittleScriptDoWhileBodyElement::GetAllExprList()
{
...
const std::vector<std::shared_ptr<ALittleScriptStringElement>>& ALittleScriptDoWhileBodyElement::GetStringList()
{
