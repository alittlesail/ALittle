...
std::shared_ptr<ALittleScriptValueStatElement> ALittleScriptDoWhileConditionElement::GetValueStat()
{
...
const std::vector<std::shared_ptr<ALittleScriptStringElement>>& ALittleScriptDoWhileConditionElement::GetStringList()
{
