...
const std::vector<std::shared_ptr<ALittleScriptAllExprElement>>& ALittleScriptElseIfBodyElement::GetAllExprList()
{
...
const std::vector<std::shared_ptr<ALittleScriptStringElement>>& ALittleScriptElseIfBodyElement::GetStringList()
{
