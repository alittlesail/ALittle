#ifndef _ALITTLE_ALittleScriptOp11SuffixEeElement_H_
#define _ALITTLE_ALittleScriptOp11SuffixEeElement_H_
...
class ALittleScriptOp11SuffixEeElement : public ABnfNodeElement
{
public:
    ALittleScriptOp11SuffixEeElement(ABnfFactory* factory, ABnfFile* file, int line, int col, int offset, const std::string& type)
        : ABnfNodeElement(factory, file, line, col, offset, type) { }
    virtual ~ALittleScriptOp11SuffixEeElement() { }
...
#endif // _ALITTLE_ALittleScriptOp11SuffixEeElement_H_
