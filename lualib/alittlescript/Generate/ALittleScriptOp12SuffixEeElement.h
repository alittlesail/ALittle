#ifndef _ALITTLE_ALittleScriptOp12SuffixEeElement_H_
#define _ALITTLE_ALittleScriptOp12SuffixEeElement_H_
...
class ALittleScriptOp12SuffixEeElement : public ABnfNodeElement
{
public:
    ALittleScriptOp12SuffixEeElement(ABnfFactory* factory, ABnfFile* file, int line, int col, int offset, const std::string& type)
        : ABnfNodeElement(factory, file, line, col, offset, type) { }
    virtual ~ALittleScriptOp12SuffixEeElement() { }
...
#endif // _ALITTLE_ALittleScriptOp12SuffixEeElement_H_
