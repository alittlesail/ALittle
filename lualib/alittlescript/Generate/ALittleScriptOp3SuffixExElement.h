#ifndef _ALITTLE_ALittleScriptOp3SuffixExElement_H_
#define _ALITTLE_ALittleScriptOp3SuffixExElement_H_
...
class ALittleScriptOp3SuffixExElement : public ABnfNodeElement
{
public:
    ALittleScriptOp3SuffixExElement(ABnfFactory* factory, ABnfFile* file, int line, int col, int offset, const std::string& type)
        : ABnfNodeElement(factory, file, line, col, offset, type) { }
    virtual ~ALittleScriptOp3SuffixExElement() { }
...
#endif // _ALITTLE_ALittleScriptOp3SuffixExElement_H_
