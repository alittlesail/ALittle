...
std::shared_ptr<ALittleScriptOp3SuffixElement> ALittleScriptOp9SuffixEeElement::GetOp3Suffix()
{
...
std::shared_ptr<ALittleScriptOp4SuffixElement> ALittleScriptOp9SuffixEeElement::GetOp4Suffix()
{
...
std::shared_ptr<ALittleScriptOp5SuffixElement> ALittleScriptOp9SuffixEeElement::GetOp5Suffix()
{
...
std::shared_ptr<ALittleScriptOp6SuffixElement> ALittleScriptOp9SuffixEeElement::GetOp6Suffix()
{
...
std::shared_ptr<ALittleScriptOp7SuffixElement> ALittleScriptOp9SuffixEeElement::GetOp7Suffix()
{
...
std::shared_ptr<ALittleScriptOp8SuffixElement> ALittleScriptOp9SuffixEeElement::GetOp8Suffix()
{
