...
std::shared_ptr<ALittleScriptValueStatElement> ALittleScriptPropertyValueBracketValueElement::GetValueStat()
{
...
const std::vector<std::shared_ptr<ALittleScriptStringElement>>& ALittleScriptPropertyValueBracketValueElement::GetStringList()
{
