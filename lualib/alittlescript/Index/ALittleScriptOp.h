...
private:
    ...
    static ABnfGuessError GuessTypeForOp4(const ABnfElementPtr& left_src, const ABnfGuessPtr& left_guess_type, const std::shared_ptr<ALittleScriptOp4SuffixElement>& op_4_suffix, ABnfGuessPtr& guess);


    static ABnfGuessError GuessTypeForOp3(const ABnfElementPtr& left_src, const ABnfGuessPtr& left_guess_type, const std::shared_ptr<ALittleScriptOp3SuffixElement>
                                          & op_3_suffix, ABnfGuessPtr& guess);
