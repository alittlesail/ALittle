...
const std::vector<std::shared_ptr<ALittleScriptValueStatElement>>& ALittleScriptBindStatElement::GetValueStatList()
{
...
std::shared_ptr<ALittleScriptKeyElement> ALittleScriptBindStatElement::GetKey()
{
...
const std::vector<std::shared_ptr<ALittleScriptStringElement>>& ALittleScriptBindStatElement::GetStringList()
{
