...
const std::vector<std::shared_ptr<ALittleScriptAllExprElement>>& ALittleScriptElseBodyElement::GetAllExprList()
{
...
const std::vector<std::shared_ptr<ALittleScriptStringElement>>& ALittleScriptElseBodyElement::GetStringList()
{
