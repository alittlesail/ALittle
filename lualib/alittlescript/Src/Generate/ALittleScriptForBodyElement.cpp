...
const std::vector<std::shared_ptr<ALittleScriptAllExprElement>>& ALittleScriptForBodyElement::GetAllExprList()
{
...
const std::vector<std::shared_ptr<ALittleScriptStringElement>>& ALittleScriptForBodyElement::GetStringList()
{
