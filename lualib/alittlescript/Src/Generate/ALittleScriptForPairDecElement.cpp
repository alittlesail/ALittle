...
std::shared_ptr<ALittleScriptVarAssignNameDecElement> ALittleScriptForPairDecElement::GetVarAssignNameDec()
{
...
std::shared_ptr<ALittleScriptAllTypeElement> ALittleScriptForPairDecElement::GetAllType()
{
...
std::shared_ptr<ALittleScriptStringElement> ALittleScriptForPairDecElement::GetString()
{
