...
const std::vector<std::shared_ptr<ALittleScriptAllExprElement>>& ALittleScriptIfBodyElement::GetAllExprList()
{
...
const std::vector<std::shared_ptr<ALittleScriptStringElement>>& ALittleScriptIfBodyElement::GetStringList()
{
