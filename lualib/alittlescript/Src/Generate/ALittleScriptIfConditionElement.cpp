...
std::shared_ptr<ALittleScriptValueStatElement> ALittleScriptIfConditionElement::GetValueStat()
{
...
const std::vector<std::shared_ptr<ALittleScriptStringElement>>& ALittleScriptIfConditionElement::GetStringList()
{
