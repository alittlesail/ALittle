#ifndef _ALITTLE_ALittleScriptOp10SuffixEeElement_H_
#define _ALITTLE_ALittleScriptOp10SuffixEeElement_H_
...
class ALittleScriptOp10SuffixEeElement : public ABnfNodeElement
{
public:
    ALittleScriptOp10SuffixEeElement(ABnfFactory* factory, ABnfFile* file, int line, int col, int offset, const std::string& type)
        : ABnfNodeElement(factory, file, line, col, offset, type) { }
    virtual ~ALittleScriptOp10SuffixEeElement() { }
...
#endif // _ALITTLE_ALittleScriptOp10SuffixEeElement_H_
