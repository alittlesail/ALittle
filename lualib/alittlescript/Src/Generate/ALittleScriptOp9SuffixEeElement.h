#ifndef _ALITTLE_ALittleScriptOp9SuffixEeElement_H_
#define _ALITTLE_ALittleScriptOp9SuffixEeElement_H_
...
class ALittleScriptOp9SuffixEeElement : public ABnfNodeElement
{
public:
    ALittleScriptOp9SuffixEeElement(ABnfFactory* factory, ABnfFile* file, int line, int col, int offset, const std::string& type)
        : ABnfNodeElement(factory, file, line, col, offset, type) { }
    virtual ~ALittleScriptOp9SuffixEeElement() { }
...
#endif // _ALITTLE_ALittleScriptOp9SuffixEeElement_H_
