...
const std::vector<std::shared_ptr<ALittleScriptAllTypeElement>>& ALittleScriptPropertyValueMethodTemplateElement::GetAllTypeList()
{
...
const std::vector<std::shared_ptr<ALittleScriptStringElement>>& ALittleScriptPropertyValueMethodTemplateElement::GetStringList()
{
