...
const std::vector<std::shared_ptr<ALittleScriptValueStatElement>>& ALittleScriptTcallStatElement::GetValueStatList()
{
...
std::shared_ptr<ALittleScriptKeyElement> ALittleScriptTcallStatElement::GetKey()
{
...
const std::vector<std::shared_ptr<ALittleScriptStringElement>>& ALittleScriptTcallStatElement::GetStringList()
{
