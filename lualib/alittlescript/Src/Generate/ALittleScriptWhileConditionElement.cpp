...
std::shared_ptr<ALittleScriptValueStatElement> ALittleScriptWhileConditionElement::GetValueStat()
{
...
const std::vector<std::shared_ptr<ALittleScriptStringElement>>& ALittleScriptWhileConditionElement::GetStringList()
{
