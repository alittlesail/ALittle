...
const std::vector<std::shared_ptr<ALittleScriptAllExprElement>>& ALittleScriptWrapExprElement::GetAllExprList()
{
...
const std::vector<std::shared_ptr<ALittleScriptStringElement>>& ALittleScriptWrapExprElement::GetStringList()
{
