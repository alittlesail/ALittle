...
std::shared_ptr<ALittleScriptValueStatElement> ALittleScriptWrapValueStatElement::GetValueStat()
{
...
const std::vector<std::shared_ptr<ALittleScriptStringElement>>& ALittleScriptWrapValueStatElement::GetStringList()
{
