...
class DeeplearningDuelingDqn
{
public:
	DeeplearningDuelingDqn(CarpRobotParameterCollection& model, int state_count, int action_count, int hide_dim)
	...
	void Copy(DeeplearningDuelingDqn& value)
	{
...
private:
	DeeplearningDuelingDqn m_eval;
	DeeplearningDuelingDqn m_target;
